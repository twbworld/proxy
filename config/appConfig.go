...
type AppConfig struct{
	...
	GinAddr string `default:":8080" json:"ginAddr" mapstructure:"ginAddr" info:"gin监听的地址"`
	...
	UsersPath string `default:"dao/users.json" json:"usersPath" mapstructure:"usersPath" info:"用户配置"`
